...
function ButtonUI({ name, onClick, loading }) {
  return (
    <button
      type="submit"
      onClick={onClick}
      disabled={loading}
      className={`relative w-full p-px font-semibold leading-6 text-white no-underline bg-gray-800 shadow-2xl cursor-pointer group rounded-xl shadow-zinc-900 ${
